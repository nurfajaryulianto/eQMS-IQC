...
-- ─── DEVELOPMENT MODE ───────────────────────────────────────
-- Izinkan anon membaca & menulis (hapus saat production)
CREATE POLICY "dev_anon_style_models" ON public.style_models
  FOR ALL TO anon USING (true) WITH CHECK (true);

-- ─── PRODUCTION MODE ────────────────────────────────────────
-- Uncomment ini dan hapus policy dev_anon_style_models di atas
-- setelah beralih ke production auth:
/*
-- Semua user login bisa SELECT (dipakai form inspeksi)
